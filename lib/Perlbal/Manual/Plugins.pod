...
Let's assume you want to create a plugin that checks requests for a X-Magic header and, if present, add an header X-Color to the response. Let's assume your plugin will be called Perlbal::Plugin::ColorOfMagic.
