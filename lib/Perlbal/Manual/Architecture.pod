...
How much data a ClientProxy object should buffer from a backend.
...
Perlbal::Service; name of a service a selector should default to.
...
Int; verification mode, see C<IO::Socket::SSL>.
