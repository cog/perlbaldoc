...
We already got in touch with Dormando, one of Perlbal's main developers/committers/release managers, who told us "That'd be great."

Dormando pointed out the desire to write documentation for Perlbal and also the lack of time on his behalf.

We're in touch with Dormando to make sure the resulting documentation is in conformity to what would be expected.
...
Since our plan comprises 6 weeks, we're expecting it to take us 8.
...
It could also happen that we finish the project in 4-5 weeks, but our experience tells us we're better off with antecipating one rough week over the course of each month.

We'll still be aiming at the 6 week schedule, though, and doing our best to reach that target.


We can begin work after returning from YAPC::EU, which for us will be by August 16th (this would make the end date October 11th).
...
This should be readable, easy to understand, and contain instructions and examples on the six following subjects:
