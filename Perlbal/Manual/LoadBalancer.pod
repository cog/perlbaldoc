...
When it comes to C<Perlbal>, the Load Balancer is implemented as a Reverse Proxy without its options, and that's why you set the role of a Load Balancer to C<reverse_proxy>:
